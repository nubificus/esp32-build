...
json_input='{ "apps":[ {"repo":"nubificus/fmnist-esp-ota","branch":"main","version":"0.4.1","type":"fmnist", "model":"models/resnet8_frozen.tflite" } ], "targets":["esp32","esp32s2","esp32s3"], "keys":[""] }'
