...
#json_input='{ "apps":[ {"repo":"nubificus/fmnist-esp-ota","branch":"main","version":"2.2.2","type":"resnet","model":"models/resnet8_frozen.tflite","tensor_allocation_space":"204800","prebuild":"scripts/prebuild.sh"} ], "targets":["esp32s3","esp32s3r2","esp32s3r8"], "builder_image": "harbor.nbfc.io/nubificus/esp-idf:x86_64-slim", "keys":["ESP32_KEY3"] }'
#json_input='{ "apps":[ {"repo":"nubificus/esp32-cam-stream","branch":"main","version":"0.1.0","type":"stream"}, {"repo":"nubificus/esp32-cam-motion","branch":"main","version":"0.1.0","type":"stream"} ], "targets":["esp32"], "builder_image": "harbor.nbfc.io/nubificus/esp-idf:x86_64-slim", "keys":[""] }'
#json_input='{ "apps":[ {"repo":"nubificus/esp32-cam-stream","branch":"main","version":"0.1.0","type":"stream"} ], "targets":["esp32"], "builder_image": "harbor.nbfc.io/nubificus/esp-idf:x86_64-slim", "keys":[""] }'
json_input1='{ "apps":[ {"repo":"nubificus/esp32-cam-motion","branch":"main","version":"0.1.0","type":"motion"} ], "targets":["esp32"], "builder_image": "harbor.nbfc.io/nubificus/esp-idf:x86_64-slim", "keys":[""] }'
json_input2='{ "apps":[ {"repo":"nubificus/esp32-cam-stream","branch":"main","version":"0.1.0","type":"stream"} ], "targets":["esp32"], "builder_image": "harbor.nbfc.io/nubificus/esp-idf:x86_64-slim", "keys":[""] }'
json_input3='{ "apps":[ {"repo":"nubificus/esp32-sensor-read","branch":"main","version":"0.1.0","type":"sensor"} ], "targets":["esp32","esp32c6","esp32s3","esp32s2"], "builder_image": "harbor.nbfc.io/nubificus/esp-idf:x86_64-slim", "keys":[""] }'

#for json_input in "$json_input1" "$json_input2" "$json_input3";
for json_input in "$json_input2";
do
...
curl -X POST \
  ...
  -d "{ \"ref\": \"feat_unsigned\", \"inputs\": { \"json_input\": $escaped_json_input } }"
