...
json_input='{ "apps":[ {"repo":"nubificus/fmnist-esp-ota","branch":"feat_build_actions","version":"0.4.1","type":"fmnist","model":"models/simple_cnn_tf_frozen.tflite","tensor_allocation_space":"204800"} ], "flash_sizes":["4MB","8MB"], "targets":["esp32s3"], "keys":["ESP32_KEY3"] }'
