...
json_input='{ "apps":[ {"repo":"nubificus/fmnist-esp-ota","branch":"feat_build_actions","version":"0.4.1","type":"fmnist", "model":"models/simple_cnn_tf_frozen.tflite" } ], "targets":["esp32s3"], "keys":[""] }'
